    ...
    <div className="mt-12 ">
      ...
      <div>
        ...
        <div className="card-body flex-1">
          ...
          <div className='text-gray-400 flex items-center'> {advertisement?.verified ?<div className='flex items-center'> <h1>verified</h1> <img src={"verified"} className="w-12" alt="" /></div> : "Unverified"}
          </div>
          <p className="text-sm text-gray-500 ">Post by {advertisement?.name} 
          {/* badge */}
